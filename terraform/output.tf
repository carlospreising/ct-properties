...
output "email" {
  value       = google_service_account.ct-properties-sa.email
  description = "The e-mail address of the service account."
}

output "name" {
  value       = google_service_account.ct-properties-sa.name
  description = "The service account name."
}

# private key
output "private_key" {
  value     = google_service_account_key.ct-properties-sa-key.private_key
...
output "decoded_private_key" {
  value     = base64decode(google_service_account_key.ct-properties-sa-key.private_key)
  sensitive = true
}
